...
function Home() {
  return (
    <div>
      ...
      <section
        id="hero"
        className="relative flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-center"
      >
        <div className="max-w-3xl px-4 py-16 mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold bg-gradient-to-r from-red-700 to-purple-400 bg-clip-text text-transparent mb-6">
          ...
          <div className="flex flex-row justify-center items-center gap-4">
            <Link
              to="/icons"
              className="px-4 py-2 sm:px-6 sm:py-3 bg-gradient-to-tr from-orange-400 to-red-700 hover:from-red-500 hover:to-yellow-500 transition-all duration-300 rounded-xl text-white font-semibold shadow-lg hover:shadow-xl"
            >
              Icons
            </Link>
            <Link
              to="/components"
              className="px-4 py-2 sm:px-6 sm:py-3 bg-gradient-to-tr from-red-700 to-orange-400 hover:from-orange-400 hover:to-red-500 transition-all duration-300 rounded-xl text-white font-semibold shadow-lg hover:shadow-xl"
            >
              Components
            </Link>
          </div>
